...
;(function(window) {
	...
	Point.prototype.options = {
		...
		maxDistance : 100, 
		// If viewportFactor is different than -1, then the maxDistance will be overwritten by [windowÂ´s width / viewportFactor]
		viewportFactor : -1,
	...
	PointsMap.prototype.options = {
		...
		// The distance from the mouse pointer to a Point where the opacity of the background element is 0.
		maxDistance : 100, 
		// If viewportFactor is different than -1, then the maxDistance will be overwritten by [pointÂ´s parent width / viewportFactor]
		viewportFactor : 9,
	...
	/**
	 * Calls a PointÂ´s fn. Excludes the point with index = excludedPoint.
	 */
