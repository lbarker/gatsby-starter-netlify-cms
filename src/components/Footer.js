    ...
    <footer> 
        <div className="wrapper"> 
            ...
            <div className="footer-nav">
                <ul>
                    <li><a href="{{ site.baseurl }}">Cal Poly Corporation</a></li>
                    <li className="br"></li>
                    <li><a href="https://www.calpolycorporation.com/"></a></li>
        ...
        <div className="copyright">
            <ul>
                <li><a href="http://www.calpoly.edu/" target="_blank">Cal Poly Home</a></li>
                <li><a href="https://www.calpolycorporation.org/web-accessibility-statement/" target="_blank">Web Accessibility Statement</a></li>
                <li><a href="https://www.calpolycorporation.org/terms-of-use-and-privacy-policy/" target="_blank">Privacy Notice</a></li>
            </ul>
